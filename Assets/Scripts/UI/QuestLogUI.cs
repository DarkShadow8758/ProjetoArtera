...
public class QuestLogUI : MonoBehaviour
{
    ...
    private void QuestLogTogglePressed(InputEventContext inputEventContext)
    {
        // if (!inputEventContext.Equals(InputEventContext.QUESTLOG))
        // {
        //     return;
        // }
    ...
    {
        //quest name
        questDisplayNameText.text = "Nível " + quest.info.levelRequirement;

        //status
        questStatusText.text = quest.GetFullStatusText();

        //requirements 
        levelRequirementsText.text = "Nível " + quest.info.levelRequirement;
        ...
        //rewards
        goldRewardsText.text = quest.info.goldReward + " Moeda";
